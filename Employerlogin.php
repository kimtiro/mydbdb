...
if(isset($_POST['submit']))
{
  ...
  $query=mysqli_query($con,"SELECT * FROM employer WHERE emailaddress='$emailaddress' and password='$password'");
  $num=mysqli_fetch_array($query);
if($num>0)
{
  $extra="employer-dashboard.php";//
  $_SESSION['alogin']=$_POST['emailaddress'];
  $_SESSION['employer_id']=$num['employer_id'];
          ...
          <div class="col-xl-4 col-md-6">
            <div class="access-form">
              <div class="form-header">
                <h5><i data-feather="user"></i>Employer Login</h5>
              </div>
