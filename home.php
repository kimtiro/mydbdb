    ...
    <header>
      <nav class="navbar navbar-expand-xl absolute-nav transparent-nav cp-nav navbar-light bg-light fluid-nav">
          ...
          <ul class="navbar-nav ml-auto main-nav">
            ...
            <li class="menu-item dropdown">
              ...
              <ul  class="dropdown-menu">
                ...
                <li class="menu-item"><a href="Employerlogin.php">Login</a></li>
        ...
        <!--    <li class="menu-item login-popup"><button title="Title" type="button" data-toggle="modal" data-target="#exampleModalLong">Login</button></li>
            ...
            <li class="menu-item dropdown">
              <a title="" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">Login</a>
              <ul  class="dropdown-menu">
                <li class="menu-item"><a href="Employerlogin.php">Login As Employer</a></li>
                <li class="menu-item"><a href="freelancerlogin.php">Login As Freelancer</a></li>
              </ul>
              <li class="menu-item dropdown">
              <a title="" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" aria-expanded="false">Registration</a>
              <ul  class="dropdown-menu">
                <li class="menu-item"><a href="EmployerRegistration.php">Register As Employer</a></li>
                <li class="menu-item"><a href="freelancerRegistrationPage.php">Register As Freelancer</a></li>
              </ul>
          </ul> 
        </div>
      </nav>
