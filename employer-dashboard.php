            ...
            <div class="dashboard-container">
              <div class="dashboard-content-wrapper">
                <div class="dashboard-section user-statistic-block">
                  <?php 
                    $sql=mysqli_query($con,"select count(job_id) as total from jobs where employer_id ='".$_SESSION['employer_id']."'");
                  ...
                  <?php } ?>
                  <?php 
                    $sql=mysqli_query($con,"select jobs.job_id as job_id,count(freelancer_id) as total from jobapplication join jobs on jobs.job_id = jobapplication.job_id where jobs.employer_id ='".$_SESSION['employer_id']."'");
                    while($row=mysqli_fetch_array($sql))
                    {
                  ?>
                  <div class="user-statistic">
