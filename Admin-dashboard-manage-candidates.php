...
if(isset($_GET['del']))
      {
              mysqli_query($con,"delete from freelancer where freelancer_id = '".$_GET['freelancer_id']."'");
                  $_SESSION['delmsg']="Freelancer deleted !!";
      }
?>
<!doctype html>
<html lang="en">
              ...
              <form action="#" class="dashboard-form job-post-form" method="post" enctype="multipart/form-data">
                ...
                <div class="manage-job-container">
                  <table class="table">
                    ...
                    <?php
                    $sql=mysqli_query($con,"select * from freelancer");
                    $cnt=1;
                    ...
                    ?>
                      ...
                      <tr class="job-items">
                        ...
                        <td class="application"><?php echo htmlentities($row['emailaddress']);?></a></td>
                        <td class="deadline"><?php echo htmlentities($row['password']);?></td>
                   <!--     <td class="status active">Active</td>-->
                        <td class="action">
                         <!-- <a href="#" class="preview" title="Preview"><i data-feather="eye"></i></a>
                          <a href="#" class="edit" title="Edit"><i data-feather="edit"></i></a>-->
                          <a class="remove" href="Admin-dashboard-manage-candidates.php?freelancer_id=<?php echo $row['freelancer_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i data-feather="trash-2"></i></a>
                        </td>
                      </tr>
                      <?php 
                      $cnt++;
