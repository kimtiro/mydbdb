...
if(isset($_GET['del']))
      {
              mysqli_query($con,"delete from freelancer where employer_id = '".$_GET['employer_id']."'");
              ...
              <form action="#" class="dashboard-form job-post-form" method="post" enctype="multipart/form-data">
                ...
                <div class="manage-job-container">
                  <table class="table">
                    ...
                    <?php
                    $sql=mysqli_query($con,"select * from employer");
                    $cnt=1;
                   ...
                   <!--     <td class="status active">Active</td>-->
                        <td class="action">
                         <!-- <a href="#" class="preview" title="Preview"><i data-feather="eye"></i></a>
                          ...
                          <a class="remove" href="Admin-dashboard-manage-employer.php?employer_id=<?php echo $row['employer_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i data-feather="trash-2"></i></a>
                        </td>
                      </tr>
                      <?php 
                      $cnt++;
