...
$ret=mysqli_query($con,"insert into freelancer(emailaddress,password) values('$emailaddress','$password')");
if($ret)
{
$_SESSION['msg']="Registered Successfully !!";
echo "<script> window.location.assign('freelancerlogin.php'); </script>";
}
else
{
...
<html lang="en">
  ...
  <body>
          ...
          <div class="col-xl-4 col-md-6">
            <div class="access-form">
              <div class="form-header">
                <h5><i data-feather="edit"></i>Register Freelancer Account</h5>
              </div>
    ...
    $("#loaderIcon").show();
    jQuery.ajax({
    url: "freelancerCheckAvailability.php",
